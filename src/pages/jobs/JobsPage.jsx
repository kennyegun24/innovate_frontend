...
const JobDetails = () => {
    ...
    return (
        <div style={{ padding: '0 1rem 0 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'flex-start' }}>
            ...
            <Link to={`/jobs/${urlName}/${urlId}/apply`} style={{ justifySelf: 'flex-start', color: '#fff', background: '#5596E6', padding: '0.5rem', borderRadius: '10px', textDecoration: 'none' }}>Apply Now</Link>
        </div>
    )
}
