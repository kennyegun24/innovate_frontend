    ...
    <div className="flex column gap2rem">
      <div className="flex column gap2rem relative">
        ...
        >
          ...
          <Link
            to={
              currentUser?.data?.id === data.author_id
                ? "/profile"
                : `/user/${data.author_name}/${data.author_id}/profile`
            }
          ...
          <p className="font14 opacity05">
            Estimated reading time: {readTime(data.text)}
          </p>
          <p className="font14 opacity05">
            Words count: {wordCount(data?.text)} words
          </p>
        </div>
        <div>
          <img
        ...
        {comments.map((comment) => (
          ...
          >
            ...
            >
              <Link
                to={
                  currentUser?.data?.id === comment.user_id
                    ? "/profile"
                    : `/user/${data.author_name}/${data.author_id}/profile`
                }
                className="opacity05"
            ...
            <p
              style={{ whiteSpace: "pre-line", maxWidth: "75%" }}
              className="font14"
            >
              {comment.comment}
            </p>
